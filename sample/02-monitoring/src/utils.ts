...
export const updateDashboard = async (
  ...
  try {
    ...
    const resp = await axios.post(
      grafanaBaseURL + '/api/dashboards/db',
      {
        dashboard: dashboardJSON,
        message: 'update the response time dashboard',
        overwrite: true,
      },
      {
        headers: {
    ...
    /*.then((res) => {
      console.log('response after successful updation of dashboard using grafana api: ', res);
      return res.data;
    }).catch((err) => {
      console.error('error updating the dashboard using grafana api: ', err);
    });*/
    console.log('resp: ', resp.data);
    return resp.data;
  } catch (err) {
    console.error('Error updating the dashboard via API Call: ', err);
  }
  return;
};
...
export const getDashboardByUID = async (
  ...
  try {
    ...
    /*.then((res) => {
      console.log('fetched the dashboard json: ', res);
      return res.data.dashboard;
    }).catch((err) => {
      console.log('error getting dashboard by uid: ', err);
    })*/
  } catch (err) {
